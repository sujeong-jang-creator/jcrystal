...
select trunc(5.987654321,2) from dual;
select trunc(12345.987654321,-2) from dual;
...
--2. ? manager로 job 칼럼과 뜻(대소문자 구분 없이)이 일치되는 사원의 사원명 검색하기 
-- 소문자로 검색시 검색 불가
...
--8.? 2020년 2월의 마지막 날짜는?
select last_day('2020-02-08') from dual;
